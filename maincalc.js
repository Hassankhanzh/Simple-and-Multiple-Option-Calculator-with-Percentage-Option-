...
if (answers1.operator === "Addition") {
    console.log(`Your Answer is ${answers1.first_Number1 + answers1.second_Number2}`);
}
else if (answers1.operator === "Subtraction") {
    console.log(`Your Answer is ${answers1.first_Number1 - answers1.second_Number2}`);
}
else if (answers1.operator === "Multiplication") {
    console.log(`Your Answer is ${answers1.first_Number1 * answers1.second_Number2}`);
}
else if (answers1.operator === "Division") {
    console.log(`Your Answer is ${answers1.first_Number1 / answers1.second_Number2}`);
}
else if (answers1.operator === "Percentage") {
    console.log(`Your Answer is ${answers1.first_Number1 / answers1.second_Number2 * 100}%`);
}
else if (answers1.operator === "None") {
